...
class LwaziAPI {
    ...
    static async getTutors(params = {}) {
        try {
            ...
            let tutors = [
                { id: 1, full_name: 'Thabo Mokoena', subjects: ['Mathematics','Physical Sciences'], grade_levels: ['10','11','12'], bio: 'Passionate about making Mathematics and Physical Sciences accessible. I hold a BSc in Applied Mathematics from Wits and have been tutoring full-time for 6 years. My students consistently achieve distinctions in the NSC.', hourly_rate: 250, experience_years: 6, rating: 4.8, review_count: 47, verified: true, qualification: 'BSc Applied Mathematics — Wits University' },
                { id: 2, full_name: 'Sarah van den Berg', subjects: ['English Home Language','English First Additional Language','Afrikaans'], grade_levels: ['8','9','10','11','12'], bio: 'UCT English Honours graduate specialising in literature analysis and creative writing. I focus on building genuine comprehension and analytical skills, not just exam technique. My approach is holistic and student-centred.', hourly_rate: 200, experience_years: 4, rating: 4.9, review_count: 62, verified: true, qualification: 'BA Honours English Literature — UCT' },
